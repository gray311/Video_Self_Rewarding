...
def register_datasets_mixtures():
    ...
    sharegpt4video_sft = Dataset(
        dataset_name='sharegpt4video_sft',
        dataset_type='torch',
        data_path='./playground/data/sharegpt4video/sharegpt4v_mix738k_remove_sa.json',
        image_path='./playground/data/sharegpt4video'
    )
    add_dataset(sharegpt4video_sft)
